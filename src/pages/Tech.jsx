...
export default function Tech() {
  ...
  const projects = [
    ...
    { title: "DTM (Design Thinking Machine) AI-agent", desc: "An ongoing prompt-engineered AI system to guide structured design thinking", details: "A prompt-engineered AI system using ReactJS and FastAPI to guide structured design thinking through relevant crisp questioning  and conversational workflows using Puter.js for open-source API keys used for OpenAPI integration. Exploring RAG architecture, vector embeddings, adaptive AI UI states, and multi-agent orchestration concepts. Tech stack used in this project: ReactJS, FastAPI in Python.", img: "/design project 1 vision img.png" },

    { title: "JSON Renderer (Config-Driven UI System)", desc: "Dynamic UI rendering engine using JSON configurations", details: "Built a scalable JSON-driven UI renderer supporting dashboards, tables, conditional forms, and steppers, with robust handling of invalid configs, dynamic state, and complex user interaction flows. Tech stack used in this project: ReactJS.", url:"https://json-renderer-seven.vercel.app/", img: "/tech project img 3.png" },
      ...
      <section id="about" className="section">
        <div className="about-grid">
          <div className="about-text">
            ...
            <div className="section-content">I'm a software developer with experience in scalable UI systems and backend services for cloud platforms. I love solving user problems and building seamless user experiences with a strong focus on usability, performance, and intuitive design systems. 
              <br></br>
              <br></br>
...
<p><span style={{ fontStyle: 'italic' }}>Bengaluru, IN</span></p>
<br></br><br></br>
<p>Software Developer - UX Engineering</p>
<br></br>
              <br></br>
<ul>
          <li>Owned frontend architecture and design-system of a shared React + TypeScript component library adopted by <span style={{ color: '#00d4ff' }}>150+ plugin teams</span> across oracle.com and OCI, cutting duplicate UI code by ~30% and shortening new-plugin delivery cycles</li>
          <li>Developed <span style={{ color: '#00d4ff' }}>UI components</span> with Storybook and <span style={{ color: '#00d4ff' }}>template builders</span> using React and TypeScript for OCI Console (MAUI) which are being used across 150+ teams at OCI for a consistent interface experience throughout</li>
          <li>Enabled scalable UI development through <span style={{ color: '#00d4ff' }}>config-driven templates</span> to standardise interfaces across enterprise plugin ecosystems</li>
          ...
          <li>Contributed to building an <span style={{ color: '#00d4ff' }}>internal AI-powered chatbot assistant</span> using OpenAI and Gemini APIs which leverages a structured knowledge base using manual-RAG architecture for plugin teams to self-serve first-line configuration queries and reducing reliance on on-call developer's support by ~30%</li>
...
<ul>
      ...
      <section id="skills" className="section">
        ...
        <div className="section-content">
        <ul>
          <li><span style={{ color: '#00d4ff' }}>Frontend</span>: JavaScript (ES6+), HTML5, CSS3, TypeScript, React, Preact</li>
          <li><span style={{ color: '#00d4ff' }}>Backend</span>: Python, Java, C, SQL, REST APIs</li>
          <li><span style={{ color: '#00d4ff' }}>Tools and Methodologies</span>: Git/Github, Linux, Terraform, Postman, CI/CD, Agile, Scrum, Version Control</li>
          <li><span style={{ color: '#00d4ff' }}>Cloud and Deployment</span>: Oracle Cloud Infrastructure (OCI), DevOps</li>
          <li><span style={{ color: '#00d4ff' }}>UI / UX</span>: Figma, UX design principles</li>
          <li><span style={{ color: '#00d4ff' }}>Relevant courses</span>: DSA, Database systems, OOP Design Patterns, Cloud Computing, HCI, Machine Learning</li>
        </ul>
      ...
      <section id="leadership" className="section">
        ...
        <ul>
          ...
          <ul>
            ...
            <li>Check 'Beyond Career' section for photos!</li>
          </ul>
          </li>
